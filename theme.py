...
/* Also explicitly hide Streamlit's built-in nav separator line if present */
...
button[aria-label="Navigate to home page"] img {
  ...
  transform: scale(1.15) !important; /* enlarges the logo beyond standard bounding box without expanding container */
...
/* Separator between logo and nav — hidden, zero height */
[data-testid="stSidebarNavSeparator"],
...
/* ── Glide Data Grid (canvas-based) light theme overrides ──────────── */
/* These CSS custom properties are read by Streamlit's Glide Data Grid  */
/* to paint cell backgrounds, text, and borders on the canvas.           */
[data-testid="stDataFrame"] *,
[data-testid="stDataFrame"] {
  --gdg-bg-cell: #ffffff !important;
  --gdg-bg-cell-medium: #f8fafc !important;
  --gdg-bg-header: #f1f5f9 !important;
  --gdg-bg-header-has-focus: #e8edf5 !important;
  --gdg-bg-header-hovered: #e8edf5 !important;
  --gdg-bg-bubble: #f1f5f9 !important;
  --gdg-bg-bubble-selected: #dde3f0 !important;
  --gdg-bg-search-result: rgba(79,110,247,0.12) !important;
  --gdg-border-color: rgba(15,23,42,0.14) !important;
  --gdg-horizontal-border-color: rgba(15,23,42,0.10) !important;
  --gdg-drilldown-border: rgba(79,110,247,0.40) !important;
  --gdg-accent-color: #4f6ef7 !important;
  --gdg-accent-fg: #ffffff !important;
  --gdg-accent-light: rgba(79,110,247,0.12) !important;
  --gdg-text-dark: #0f172a !important;
  --gdg-text-medium: #475569 !important;
  --gdg-text-light: #94a3b8 !important;
  --gdg-text-bubble: #0f172a !important;
  --gdg-text-header: #475569 !important;
  ...
  --gdg-link-color: #4f6ef7 !important;
}
...
def cost_banner(monthly: float, annual: float, five_yr: float, sub1: str = "Production", sub2: str = "with environments", sub3: str = "4% inflation/yr"):
    st.markdown(f"""
