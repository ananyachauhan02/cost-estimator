...
Step 6: excel_exporter.generate_excel_reports()
    │   Workbook 1: cloud_sizing.xlsx (always)
    │   Workbook 2: aws_pricing_forecast.xlsx (SaaS only)
...
|---|---|---|
| SaaS | `cloud_sizing.xlsx` | Cloud Sizing · DB Selection · Pre-Prod SIT UAT · DR Environment |
| SaaS | `aws_pricing_forecast.xlsx` | AWS Pricing · Pre-Prod SIT UAT · DR Environment · PUPM Summary · GCP Pricing · AWS vs GCP Comparison |
...
| `aws_pricing_xlsx` | str (path) | Step 6 complete | Clear Results |
...
excel_exporter.generate_excel_reports(...)
    │  cloud_sizing.xlsx      — node architecture
    │  aws_pricing_forecast.xlsx  — costs + PUPM + GCP + comparison
    ▼
