...
with title_col:
    ...
    <div class="bn-page-header">
      <div>
        <div class="bn-page-title">Clients</div>
...
<div class="bn-metrics">
  ...
  <div class="bn-metric-card purple">
    <div class="bn-metric-label">Active Sectors</div>
    <div class="bn-metric-value">{len(set(c.get('sector','Default') for c in clients))}</div>
    <div class="bn-metric-delta flat">Unique industry verticals</div>
  </div>
</div>
""", unsafe_allow_html=True)
