...
| 12 | Excel reports generated (Cloud Sizing + AWS Pricing) | `excel_exporter.py` |
...
| **AWS Pricing Report** (`AWS_Pricing_<client>.xlsx`) | Itemized EC2, RDS, EBS, S3 costs; monthly/annual/5-year totals; reserved vs on-demand comparison; GCP comparison tab |
